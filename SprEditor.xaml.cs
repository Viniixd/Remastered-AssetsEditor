...
namespace Assets_Editor
{
    ...
    public partial class SprEditor : Window
    {
        ...
        private void CommandCopyFlags_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            _editor?.TriggerCopyFlagsShortcut();
            e.Handled = true;
        }

        private void CommandPasteFlags_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            _editor?.TriggerPasteFlagsShortcut();
            e.Handled = true;
        }

        private void CommandSave_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            _editor?.TriggerSaveShortcut();
            e.Handled = true;
        }

        private void CommandClearFlags_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            _editor?.TriggerClearFlagsShortcut();
            e.Handled = true;
        }

        private void CommandDuplicate_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            _editor?.TriggerDuplicateShortcut();
            e.Handled = true;
        }

        private void EditorCommandCanExecute(object sender, CanExecuteRoutedEventArgs e)
        {
            e.CanExecute = _editor != null;
        }
